...
export default function HomePage(){
 ...
 return (
  ...
  <p className="text-center mt-[2rem]">
      ...
      <img className="mt-[2rem] w-20" src="https://64.media.tumblr.com/6fb49796364519b50627ef20d1ee9bfd/989ae70bbd8fd464-61/s500x750/bf1ba1d902fe3b62ef611e4ecee843fa8417cdeb.gifv"/>
    </div>
  );
}